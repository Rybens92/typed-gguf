### determinism — Spark-X2.5-4B-Q8_0.gguf

- generated: 2026-09-18T13:53:08Z
- host: Linux-7.2.4-ogc3.1.fc44.x86_64-x86_64-with-glibc2.41 · cpus 24 · cgroup quota 2.0
- config: backend=auto runs=1 threads=2
- reproduce: `uv run ggufone bench --suite determinism --model /var/home/rybens/.hermes/models/Spark-X2.5-4B-Q8_0.gguf --backend auto --quick --threads 2 --json`
...
|---|---|---|
| cpu | yes | `sha256:a81f13b156a9fceb…` |
...
report: /work/t_f46cec41/evidence/spark_quick2/quick_determinism.json
