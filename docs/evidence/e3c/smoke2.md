...
sched_reserve: reserve took 3.72 ms, sched copies = 1`- dev items: c01 (choice 1) · label variants: `bare`, `newline` · generated 2026-09-19T15:41:41Z
- engine floor: coverage < **0.10** ⇒ `low_mass` (`OPTION_DEFAULTS['coverage_floor']`)
- shapes: `shipped`, `two_step_shipped`
- wall: 20.4 s (one model load 668 ms, one context per item, all shapes of one item in one decode batch)
...
| `shipped` | `newline` | 1.0000 | 1/1 | 1.0000 |
| `two_step_shipped` | `bare` | 0.9506 | 1/1 | 0.9506 |
| `two_step_shipped` | `newline` | 0.0007* | 0/1 | 0.0007 |
...
|---|---|---|---|---|---|---|---|
| `shipped=bare` | 1 | 0 | 0.000 | 0.000–0.793 | 1/1 | 0.0114 | 1/1 |
| `two_step_shipped=bare` | 1 | 1 | 1.000 | 0.207–1.000 | 0/1 | 0.9506 | 1/1 |
