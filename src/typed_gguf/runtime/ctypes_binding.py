...
from typed_gguf.errors import RuntimeMissingError, RuntimeSymbolsError
from typed_gguf.runtime.finder import library_names
...
def _bind_optional(runtime: Runtime) -> None:
    ...
    no-argument getter segfaults the process (measured on the pinned CPU bundle: `typed-gguf ask`
